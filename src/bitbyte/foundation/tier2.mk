...
ifeq ($(BITBYTE_FOUNDATION_TIER2_LINKAGE),statically)
  TIER2 := lib/$(STATIC_LIB_PREFIX)tier2$(STATIC_LIB_SUFFIX)$(STATIC_LIB_EXTENSION)
endif
ifeq ($(BITBYTE_FOUNDATION_TIER2_LINKAGE),dynamically)
  TIER2 := bin/$(SHARED_LIB_PREFIX)tier2$(SHARED_LIB_SUFFIX)$(SHARED_LIB_EXTENSION)
endif

ifeq ($(TOOLCHAIN),msvc)
  TIER2_IMPORT_LIB := $(STATIC_LIB_PREFIX)tier2$(STATIC_LIB_SUFFIX)
else
...
BITBYTE_FOUNDATION_TIER2_SOURCES := $(shell find src/bitbyte/foundation/tier2 -name '*.cc')
BITBYTE_FOUNDATION_TIER2_OBJECTS := $(addprefix obj/, $(subst src/,,$(BITBYTE_FOUNDATION_TIER2_SOURCES:%.cc=%.o)))
BITBYTE_FOUNDATION_TIER2_OBJECTS += obj/bitbyte/foundation/tier2.o
...
obj/bitbyte/foundation/tier2/%.o: src/bitbyte/foundation/tier2/%.cc
	@echo "[CC] $<"
	@mkdir -p ${@D}
