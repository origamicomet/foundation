...
/// \def BITBYTE_FOUNDATION_SYSTEM_UNKNOWN
/// \copydoc BITBYTE_FOUNDATION_TIER0_SYSTEM_UNKNOWN
#define BITBYTE_FOUNDATION_SYSTEM_UNKNOWN \
  BITBYTE_FOUNDATION_TIER0_SYSTEM_UNKNOWN
/// \def BITBYTE_FOUNDATION_SYSTEM_WINDOWS
/// \copydoc BITBYTE_FOUNDATION_TIER0_SYSTEM_WINDOWS
#define BITBYTE_FOUNDATION_SYSTEM_WINDOWS \
  BITBYTE_FOUNDATION_TIER0_SYSTEM_WINDOWS
/// \def BITBYTE_FOUNDATION_SYSTEM_MAC_OS_X
/// \copydoc BITBYTE_FOUNDATION_TIER0_SYSTEM_MAC_OS_X
#define BITBYTE_FOUNDATION_SYSTEM_MAC_OS_X \
  BITBYTE_FOUNDATION_TIER0_SYSTEM_MAC_OS_X
/// \def BITBYTE_FOUNDATION_SYSTEM_LINUX
/// \copydoc BITBYTE_FOUNDATION_TIER0_SYSTEM_LINUX
#define BITBYTE_FOUNDATION_SYSTEM_LINUX \
  BITBYTE_FOUNDATION_TIER0_SYSTEM_LINUX
/// \def BITBYTE_FOUNDATION_SYSTEM_ANDROID
/// \copydoc BITBYTE_FOUNDATION_TIER0_SYSTEM_ANDROID
#define BITBYTE_FOUNDATION_SYSTEM_ANDROID \
  BITBYTE_FOUNDATION_TIER0_SYSTEM_ANDROID
/// \def BITBYTE_FOUNDATION_SYSTEM_IOS
/// \copydoc BITBYTE_FOUNDATION_TIER0_SYSTEM_IOS
#define BITBYTE_FOUNDATION_SYSTEM_IOS \
  BITBYTE_FOUNDATION_TIER0_SYSTEM_IO

#ifdef __BITBYTE_FOUNDATION_IMPORT__
  /// \copydoc bitbyte_foundation_system_t
  typedef bitbyte_foundation_system_t foundation_system_t;

  /// \def FOUNDATION_SYSTEM_UNKNOWN
  /// \copydoc BITBYTE_FOUNDATION_SYSTEM_UNKNOWN
  #define FOUNDATION_SYSTEM_UNKNOWN \
    BITBYTE_FOUNDATION_SYSTEM_UNKNOWN
  /// \def FOUNDATION_SYSTEM_WINDOWS
  /// \copydoc BITBYTE_FOUNDATION_SYSTEM_WINDOWS
  #define FOUNDATION_SYSTEM_WINDOWS \
    BITBYTE_FOUNDATION_SYSTEM_WINDOWS
  /// \def FOUNDATION_SYSTEM_MAC_OS_X
  /// \copydoc BITBYTE_FOUNDATION_SYSTEM_MAC_OS_X
  #define FOUNDATION_SYSTEM_MAC_OS_X \
    BITBYTE_FOUNDATION_SYSTEM_MAC_OS_X
  /// \def FOUNDATION_SYSTEM_LINUX
  /// \copydoc BITBYTE_FOUNDATION_SYSTEM_LINUX
  #define FOUNDATION_SYSTEM_LINUX \
    BITBYTE_FOUNDATION_SYSTEM_LINUX
  /// \def FOUNDATION_SYSTEM_ANDROID
  /// \copydoc BITBYTE_FOUNDATION_SYSTEM_ANDROID
  #define FOUNDATION_SYSTEM_ANDROID \
    BITBYTE_FOUNDATION_SYSTEM_ANDROID
  /// \def FOUNDATION_SYSTEM_IOS
  /// \copydoc BITBYTE_FOUNDATION_SYSTEM_IOS
  #define FOUNDATION_SYSTEM_IOS \
    BITBYTE_FOUNDATION_SYSTEM_IO
#endif // __BITBYTE_FOUNDATION_IMPORT__
